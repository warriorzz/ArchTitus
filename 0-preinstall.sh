...
sgdisk -n 3::+1024G --typecode=3:8300 --change-name=3:'ROOT' ${DISK} # partition 3 (Root), default start, remaining
sgdisk -n 4::-0 --typecode=3:8300 --change-name=4:'SHARED' ${DISK} # partition 4 (Shared), default start, remaining
